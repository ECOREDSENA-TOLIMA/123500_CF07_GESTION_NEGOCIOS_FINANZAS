  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-10.mb-5(data-aos="fade-right")
        figure
          img(src="@/assets/curso/temas/sintesis.svg", alt="Imagen que contiene un esquema que resume la temática vista durante este componente formativo, la cual se enfatiza en la planificación financiera, la gestión financiera y el presupuesto.")
