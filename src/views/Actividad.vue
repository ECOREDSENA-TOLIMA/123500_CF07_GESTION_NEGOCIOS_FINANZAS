  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        .titulo-segundo
          h2 Administración financiera y ejecución presupuestal
        p.mb-4 Reconocer los conceptos fundamentales de la gestión financiera para la comprensión de su funcionamiento, teniendo en cuenta la elaboración e implementación de planes financieros organizacionales.
